  ...
  return (
    <div className="space-y-4">
      <div className="bg-gray-50 border-l-4 border-gray-400 p-4 mb-4">
        <h4 className="font-bold text-gray-800 mb-2">Global Visa Access for U.S. Citizens</h4>
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div className="bg-gray-50 p-3 rounded border-l-4 border-gray-400">
          <div className="font-bold text-gray-800 mb-1">Visa-Free Access</div>
          <p className="text-gray-700">Most of Europe, Americas, and many countries in Asia and Oceania</p>
        </div>
        <div className="bg-gray-50 p-3 rounded border-l-4 border-gray-400">
          <div className="font-bold text-gray-800 mb-1">Visa Required</div>
          <p className="text-gray-700">Parts of Africa, Middle East, and some Asian countries</p>
        </div>
      </div>

      <div className="bg-gray-50 p-3 rounded text-xs">
        <p className="font-bold text-gray-800 mb-1">Key Considerations:</p>
